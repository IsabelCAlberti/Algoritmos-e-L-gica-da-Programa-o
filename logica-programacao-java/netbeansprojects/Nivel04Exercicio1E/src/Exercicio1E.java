...
// </editor-fold>
		...
		Passo 1: Leia uma matriz A do tipo vetor com 15 elementos inteiros. 
		
		Passo 2: Construir uma matriz B de mesmo tipo, 
		Atenção: Cada elemento da matriz B deve ser o resultado da fatorial correspondente
		de cada elemento da matriz A. 
		
		Passo 3: Calcular a fatorial dos elementos A
		
		Passo 4: Apresentar as matrizes A e B. 
		
		*/
		
		Integer [] numsA = new Integer [15];
		Integer [] numsB = new Integer [15];
	
			
		for (int indice = 0; indice < numsA.length; indice++) {
			numsA[indice] = readInteger("Digite o " + (indice + 1) + "º número de A");
